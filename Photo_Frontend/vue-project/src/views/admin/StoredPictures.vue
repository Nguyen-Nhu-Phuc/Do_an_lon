<template>
    <div class="stored-pictures-view container">
        <table class="table table-bordered">
            <thead class="thead-dark">
                <tr class="text-uppercase">
                    <th scope="col-1">STT</th>
                    <th scope="col">ID Picture</th>
                    <th scope="col-3">KEYWORDS</th>
                    <th scope="col-3">ĐỐI TƯỢNG</th>
                ...
                <tr class="text-justify">
                    ...
                    <td>
                        ...
                        <a href="" class="btn btn-link" @click="getIdPicture(picture)" :data-id="picture._id" data-toggle="modal"
                            data-target="#delete-picture-modal">Xóa</a>
                    </td>
                </tr>
            </tbody>
        </table>
